(function(global) {
    ...
    Language.form.EndChatMessage = {
        message: 'Thank you for chatting with us. Feel free to start a new chat session or enter your email and send a transcript of this conversation to your inbox.'
    };
    ...
    global.$_Tawk.language = Language;
})(window);